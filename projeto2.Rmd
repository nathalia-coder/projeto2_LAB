...
cat <- c("grupo", "etnia", "escolaridade", "doenca", "num_gestacoes", "gpsanguineo",
         ...
         "imcbinario", "escolaridade_bin", "paalto", "escolaridade_niveis")
...
df_reg <- df_completo %>% 
  select(
    ...
    # categoricas
    hipertensao, gpsanguineo, escolaridade_bin, categoriaimc, imcbinario, anti_hiper, sangueo, escolaridade, escolaridade_niveis
  )
