...
residuo_modelopad2 <- reglin::ggresiduals(modelopam2)
...
```{r}
modelo_sin1 <- glm(sindrome_met ~ pressao_media + imc, family = binomial(link = "logit"), data = df_reg)
modelo_sin1 %>% summary()
hnp(modelo_sin1)
tbl_regression(modelo_sin1, exponentiate = TRUE)
ConcluiAjuste(modelo_sin1)
